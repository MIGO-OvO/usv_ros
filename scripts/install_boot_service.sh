...
Environment="INTERNET_IFACE=$INTERNET_IFACE"
Environment="INTERNET_BAND=$INTERNET_BAND"
Environment="INTERNET_WIFI_RECONNECT=$INTERNET_WIFI_RECONNECT"
...
Environment="HOTSPOT_BAND=$HOTSPOT_BAND"
Environment="HOTSPOT_CHANNEL=$HOTSPOT_CHANNEL"
Environment="HOTSPOT_ALLOW_INTERNET_IFACE=$HOTSPOT_ALLOW_INTERNET_IFACE"
...
main() {
    ...
    log "internet iface: $INTERNET_IFACE"
    log "internet band: $INTERNET_BAND"
    log "internet reconnect: $INTERNET_WIFI_RECONNECT"
    log "hotspot iface: $HOTSPOT_IFACE"
    log "hotspot band: $HOTSPOT_BAND"
    log "hotspot channel: $HOTSPOT_CHANNEL"
